...
Class champ_glycerine extends base_module
{
	...
	{		
		...
		$this->alert_construction_en_cours = $this->check_construction_en_cours($var_in_module_name, $this->name_batiment, $this->user_obj->champ_glycerine->prix);
		...
		if($var_in_module_name == $this->name_batiment)
		{
			if($this->alert_construction_en_cours == 0)
			{
				...
				$this->time_finish_construct($this->user_obj->champ_glycerine->time_construct);
