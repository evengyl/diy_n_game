<div class="col-xs-10 col-lg-12 col-without-padding col-without-radius content_game">
	...
	<div class="col-lg-9" style="margin-top:1px;">
		...
		<div class="col-xs-12 col-md-12">
			...
			<div style='font-size:15px; color:red' class="col-lg-12 form-group <?php echo (isset($_SESSION['error']) OR isset($_SESSION['error_bases_down']))?'has-error':''; ?>">
				...
				{?>
					...
					<form method="post" action="?page=labos_update_tools">
						<div class="col-sm-6 col-md-4">
							<div class="thumbnail col-lg-12" style="height:360px; padding-bottom:10px;">
