		    		...
		    		<div class="col-lg-4 col-without-padding">
				      	<ul class="col-lg-12 nav navbar-nav">
					        <li class="col-lg-6" style="color:white;">
					        		...
					        		<span style="font-size:13px;">Minerais de Fer: <?= round($user->user_infos->last_culture_vg, 2) ?></span>
					        </li>

					        <li class="col-lg-6" style="color:white;">
					        		<img src="<?= Config::$path_public; ?>/images/usines.png" alt="Usines de propylène" style="max-height:25px;">
					        		<span style="font-size:13px;">Minerais d'Argent : <?= round($user->user_infos->last_usine_pg, 2) ?></span>
					        </li>

					        <li class="col-lg-6" style="color:white;">
					        		<img src="<?= Config::$path_public; ?>/images/plantes.png" alt="Champs de Glycerine" style="max-height:25px;">
					        		<span style="font-size:13px;">Minerais d'Or: <?= $user->user_infos->litter_vg ?> Lts</span>
					        </li>


					        <li class="col-lg-6" style="color:white;">
					        		<img src="<?= Config::$path_public; ?>/images/usines.png" alt="Usines de propylène" style="max-height:25px;">
					        		<span style="font-size:13px;">Bois: <?= $user->user_infos->litter_pg ?> Lts</span>
					        </li>
