				...
				<ul class="nav  nav-stacked ">
					...
					<li class="presentation cl-effect-14">
						<a style="color:white;" href="?page=champ_glycerine">
							<span class="glyphicon glyphicon-leaf"></span>&nbsp;&nbsp;Cultures du VG
						</a>
					</li>
					...
					<li class="presentation cl-effect-14">
						<a style="color:white;" href="?page=usine_propylene">
							<span class="glyphicon glyphicon-fire"></span>&nbsp;&nbsp;Industries du PG
						</a>
					</li>
					...
					<li class="presentation cl-effect-14">
						<a style="color:white;" href="?page=labos_bases">
							<span class="glyphicon glyphicon-glass"></span>&nbsp;&nbsp;Labos VG&PG
						</a>
					</li>
