...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 25 Août 2016 à 17:09
...
--
-- Contenu de la table `update_en_cours`
--

INSERT INTO `update_en_cours` (`id`, `id_user`, `name_batiment`, `time_finish`, `real_name_search`) VALUES
(2, 6, 'prix_vingt_quatre_vingt', 1472142522, 'Diminue le prix de production des bases mélangées brute  20%/80%');
