...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 06 Juillet 2016 à 18:37
...
(5, 6, 'level_culture_vg', 1467823024),
(6, 6, 'level_usine_pg', 1467820328),
(7, 6, 'level_labos_bases', 1467823930);
...
(1, 6, 5000, 50, 1467834149),
(2, 6, 2500, 25, 1467825152),
(3, 6, 950, 10, 1467819651),
(4, 6, 950, 10, 1467819655),
(5, 6, 950, 10, 1467819670);
...
(12, 6, 'price_search_1', 1467824815, 'Amélioration du prix de la recherche d''arômes de stade 1');
